  ...
  <div id="1">
    ...
    <button type="button" className="a">Drunk</button> {/* go to page 2*/}
    <button type="button" className="b">Scholar</button> {/* go to page 3*/}
  </div>
  <div id="2">
    {/* Drunk Riddle */}
    <p className="hidden">After a few more pints and shouting conversation the drunkard is finally ready to go. He picks up his giant frame and drags it away from the bar. You leave the pub with the drunkard by your side and embark on your adventure. He tells you once again that he will kill Borf and steal his treasure. He continues on at length about his plans to then buy a horse, to maybe buy a compass and to somehow attract a suitable partner. His motivations are simple and despite his intimidating demeanor he seems very good natured. He stops briefly beside the path to make sick in a bush.
    ...
    <button type="button" className="a">Moon</button> {/* go to page 4 */}
    <button type="button" className="b">Pearl</button> {/* go to page 9 */}
  </div>
  <div id="3">
      {/* Scholar Riddle */}
    <p className="hidden">You push through the panicked crowd as you hurry out of the pub in pursuit of the scholar. You barely make it out before the building erupts in flames. “Do you wish to join me on my quest?” the scholar asks. You nod. His knowledge could dispel the mystery of these tragic events. “Fantastic!” he exclaims. “These ancient scrolls tell of a castle in the forest where Borf resides. That is our destination.”
  ...
  <div id="4">
    ...
    <button type="button" className="a">Fail</button> {/* go to page 7 */}
    <button type="button" className="b">Pass</button> {/* go to page 5 */}
  </div>
